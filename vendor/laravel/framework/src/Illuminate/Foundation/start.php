...
Facade::setFacadeApplication($app); //NOTE: init facade, facade在app起到什么作用?
...
$app->registerCoreContainerAliases(); //NOTE: 核心别名注册, 告诉我们哪些是核心
...
| NOTE: 全局环境变量, 所以敏感类信息需要在这里剔除, 区分production: .env.php .env.production.php
*/
...
//NOTE: call class_alias() to make core class alias, like App, Controller, View etc.
...
$app->booted(function() use ($app, $env)
{
	...
	*/
	...
	| NOTE: 环境启动hook, start/production.php; start/local.php; start/testing.php;
	*/
